...
<title>Lista de servicos_has_ordem_servico</title>
...
function delRecord(id) {   
     ...
     if (teste==false) {
     	       window.location = "listservicos_has_ordem_servico.php";
            } 
     else window.location = "dodelservicos_has_ordem_servico.php?cod="+id;
 }
 function altnewindow(id) {
	  openwindow = window.open("altservicos_has_ordem_servico.php?cod="+id, "mywindow","location=1, status=1, scrollbars=1, width=600, height=700");
	  testwindow.moveTo(0,0);
		} 
function insnewindow() {
	  openwindow = window.open("insservicos_has_ordem_servico.php", "mywindow","location=1, status=1, scrollbars=1, width=600, height=700");
	  testwindow.moveTo(0,0)
		}
...
<thead>
 ...
 <tr> 
   ...
   <th> qtde_horas_tecnicas </th>
   <th> custo_horas_tecnica </th>
   <th> Excluir </th>  
   <th> Alterar </th>
 </tr>
 </thead>
...
$sql="SELECT * FROM servicos_has_ordem_servico";
...
while ($linha = mysqli_fetch_array($query)) {
 	 ...
 	 echo "<td>$linha[qtde_horas_tecnicas]</td>";
 	 echo "<td>$linha[custo_horas_tecnica]</td>";
