...
<title>Lista de nota_fiscal_entrada</title>
...
function delRecord(id) {   
     ...
     else window.location = "dodelnota_fiscal_entrada.php?cod="+id;
 }
 function altnewindow(id) {
	  openwindow = window.open("altnota_fiscal_entrada.php?cod="+id, "mywindow","location=1, status=1, scrollbars=1, width=600, height=700");
	  testwindow.moveTo(0,0);
		} 
function insnewindow() {
	  openwindow = window.open("insnota_fiscal_entrada.php", "mywindow","location=1, status=1, scrollbars=1, width=600, height=700");
	  testwindow.moveTo(0,0)
		}
...
$sql="SELECT * FROM nota_fiscal_entrada";
